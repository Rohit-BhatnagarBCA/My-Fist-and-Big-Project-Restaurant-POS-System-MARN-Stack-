      ...
      <div className="hidden lg:flex w-1/2 relative items-center justify-center overflow-hidden">
        ...
        {tickets.map((ticket, index) => (
          ...
          >
            ...
            <p
              className={`${labelFont} text-[10px] tracking-widest text-[#BD5D31] mb-1`}
            >
              TABLE {ticket.table}
            </p>
        ...
        <div className="absolute bottom-12 px-10 w-full">
          <p
            className={`${labelFont} text-[11px] tracking-[0.2em] text-[#BD5D31] mb-3`}
          >
            FOUNDER'S NOTE
          </p>

          <blockquote className="text-xl italic text-[#F3EEE3] leading-relaxed">
            "Serve customers the best food with
            prompt and friendly service in a
            welcoming atmosphere, and they'll
            keep coming back."
          </blockquote>

          <span
            className={`${labelFont} block mt-4 text-sm text-[#F3EEE3]/70`}
          >
            — Founder of Restro
          </span>
        </div>
                  ...
                  return (
                    <button
                      ...
                      className={`relative flex-1 py-2 text-sm font-semibold rounded-full transition-colors z-10 ${
                        active
                          ? "text-[#12181F]"
                          : "text-[#F3EEE3]/60 hover:text-[#F3EEE3]"
                      }`}
                    >
                      {active && (
                        <motion.span
          ...
          >
            ...
            <div className="bg-[#F3EEE3] rounded-b-lg px-6 sm:px-8 py-8 shadow-2xl">
              ...
              <div className="mb-6 text-center">
                <p
                  className={`${labelFont} text-[10px] tracking-[0.25em] text-[#BD5D31] mb-1`}
                >
                  {isRegister
                    ? "NEW STAFF TICKET"
                    : "STAFF ACCESS"}
